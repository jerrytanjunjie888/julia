...
"""
typeintersect(@nospecialize(a), @nospecialize(b)) = (@_total_may_throw_meta; ccall(:jl_type_intersection, Any, (Any, Any), a, b))

morespecific(@nospecialize(a), @nospecialize(b)) = (@_total_may_throw_meta; ccall(:jl_type_morespecific, Cint, (Any, Any), a, b) != 0)
